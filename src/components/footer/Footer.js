...
import Footer2Container from './footer2/Footer2Container';
            ...
            <div className="container">
                <div className="row footer-1">
                    ...
                    <div className="col-lg-6">
                        <div className="row">
                            <div className="col-lg-3 mb-3">
                                <h3><a href="https://sportsbet.io/sports">Sports</a></h3>
                                <SportsContainer/>
                            </div>
                            <div className="col-lg-3 mb-3">
                                <h3><a href="https://sportsbet.io/casino">Casino</a></h3>
                                <CasinoContainer/>
                            </div>
                            <div className="col-lg-3 mb-3">
                                <h3><a href="https://sportsbet.io/support">Support</a></h3>
                                <SupportContainer/>
                            </div>
                            <div className="col-lg-3 mb-3">
                                <h3><a href="https://sportsbet.io/about">About</a></h3>
                                <AboutContainer/>
                            </div>
                        </div>
                    </div>
                ...
                <div className="row mobile-authentication">
                    <div className="col">
                        <a className="btn btn-sign-in" href="https://sportsbet.io/id/login">Sign in</a>
                        </div>
                    <div className="col">
                        <a className="btn btn-regiser" href="https://sportsbet.io/id/signup">Register</a>
                    </div>
                </div>
        </footer>
